...
import com.sparta.willbe.batch.config.RemoveUserDeleteConfig;
...
public class RemoveUserDeleteScheduler {

    private final JobLauncher jobLauncher;
    private final RemoveUserDeleteConfig removeUserDeleteConfig;
    ...
    public void runJob() {
        ...
        try {
            jobLauncher.run(removeUserDeleteConfig.removeUser(), jobParameters);

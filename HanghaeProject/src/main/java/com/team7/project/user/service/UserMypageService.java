...
public class UserMypageService {
    ...
    private String basicProfile = "https://mylimjaeprivate.s3.ap-northeast-2.amazonaws.com/profileImg/userId-3-2022-05-11-05:03:13-profile.png"; //temp

    @Transactional
    public User save(UserRequestDto requestDto, User user) throws IOException {
    ...
    private void saveFile(MultipartFile multipartFile, Long userId) throws IOException {
        ...
        try (OutputStream os = new FileOutputStream(file)) {
            ...
            //S3로 업로드
            sendToS3(file, userId, extension, fileName);
    ...
    private void sendToS3(File file, Long userId, String extension, String fileName) throws IOException {
        ...
        try {
            ...
            profileImageUrl = "https://mylimjaeprivate.s3.ap-northeast-2.amazonaws.com/"+object.getKey();
